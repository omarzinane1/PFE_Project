...
<body>
        ...
        <div class="collapse navbar-collapse ml-5" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto mt-2" id="header_element">
            ...
            <li class="nav-item active" >
              <a name="home" id="oper" class="nav-link " href="#">Operations <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active ">
            <a id="card_client" name="card" class="nav-link ml-3" href="#">Carte_Client</a>
            </li>
              <li class="nav-item active">
                <a name="profile" id="profile" class="nav-link ml-3" href="#">Admin</a>
              </li>
          ...
          <button name="notification" id="notification" type="button" class="btn btn-primary mr-3">
            Notifications <span id="notif" style="color: red;" name="notif" class="badge badge-light black "><?=$_POST['notif']?></span>
          </button>
    ...
    ?>
      <div id="operation" class="row mt-3 ml-3">
        <div class="left_form" class="col-sm-3 mt-3   ">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Metter De L'argent</h5>
        ...
        <div class="right_retier" class="col-sm-3 mt-3 ">
          <div class="card">
            <div class="card-body">
        ...
        <div class="right_retier" class="col-sm-3 ">
          <div class="card">
            <div class="card-body">
    ...
    <!--End Card: Déposer card-->
             <!--Card: retirer card-->
                <div class="card retirer-card" id="retirer">
                    <!--card body-->
                    <div class="card-body">
            ...
            <div class="accordion accordion-flush " id="accordionFlushExample">
                ...
                if(mysqli_num_rows($req) == 0){
                    ...
                    while($row=mysqli_fetch_assoc($req)){
                      ...
                      <li>Prénom: <?=$row['first_name']?></li>
                      <li>Nom :<?=$row['last_name']?></li>
                      <li>Email :<?=$row['email']?></li>
                      <li>Password :<?=$row['password1']?></li>
                      <li>Type :<?=$row['usertype']?></li>
                      
                      <!--Nous alons mettre l'id de chaque operation dans ce lien -->
                      <li><a href="modifier.php?id=<?=$row['user_id']?>"><img src="th (30).jpg"></a>
                      <li><a href="supprimer.php?id=<?=$row['user_id']?>"><img src="th (29).jpg"></a></li>
                      </li>
